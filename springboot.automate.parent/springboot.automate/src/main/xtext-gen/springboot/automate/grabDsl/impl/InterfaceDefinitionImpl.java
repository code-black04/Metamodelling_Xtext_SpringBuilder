 ...
 *   <li>{@link springboot.automate.grabDsl.impl.InterfaceDefinitionImpl#getInterface <em>Interface</em>}</li>
...
public class InterfaceDefinitionImpl extends MinimalEObjectImpl.Container implements InterfaceDefinition
{
   ...
   * @ordered
   */
  protected EntityType interface_;
   ...
   */
  @Override
  public EntityType getInterface()
  {
    return interface_;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetInterface(EntityType newInterface, NotificationChain msgs)
  {
    EntityType oldInterface = interface_;
    interface_ = newInterface;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GrabDslPackage.INTERFACE_DEFINITION__INTERFACE, oldInterface, newInterface);
   ...
   */
  @Override
  public void setInterface(EntityType newInterface)
  {
    if (newInterface != interface_)
    {
      NotificationChain msgs = null;
      if (interface_ != null)
        msgs = ((InternalEObject)interface_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GrabDslPackage.INTERFACE_DEFINITION__INTERFACE, null, msgs);
      if (newInterface != null)
        msgs = ((InternalEObject)newInterface).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GrabDslPackage.INTERFACE_DEFINITION__INTERFACE, null, msgs);
      msgs = basicSetInterface(newInterface, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GrabDslPackage.INTERFACE_DEFINITION__INTERFACE, newInterface, newInterface));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case GrabDslPackage.INTERFACE_DEFINITION__INTERFACE:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case GrabDslPackage.INTERFACE_DEFINITION__NAME:
        ...
        return;
      case GrabDslPackage.INTERFACE_DEFINITION__INTERFACE:
        setInterface((EntityType)newValue);
        return;
      case GrabDslPackage.INTERFACE_DEFINITION__MEMBERS:
        getMembers().clear();
